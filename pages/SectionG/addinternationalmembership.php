...

{
    ...
    if ($check_staff_result->num_rows > 0) {
        ...
        if ($check_duplicate_result->num_rows == 0) {
            ...
            (`staff_id`, `staff_name`, `faculty`, `member`, `type_appointment`, `start_date`, `end_date`, `link_evidence`, `remarks`) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
        
        // Bind parameters
        $insert_sql->bind_param(
            'issssssss',
            $staff_id, $staff_name, $faculty, $member, $type_appointment,
            ...
            <form action="" method="post">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" name="member" placeholder="Academic/Professional Bodies/Associatons/NGOs" required>
                    </div>
                    <!-- Country -->
                    <div class="col-md-6 mb-3">
