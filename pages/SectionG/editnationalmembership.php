            ...
            <form action="" method="post" style="width:50vw; min-width:300px;">
                <div class="row">
                    ...
                    <select class="form-control" name="type_member" required>
                        <option value="" disabled <?php if (empty($row['type_member'])) echo 'selected'; ?>>Choose Type</option>
                        <option value="Member" <?php if ($row['type_member'] == 'Member') echo 'selected'; ?>>Member</option>
                        <option value="Committe" <?php if ($row['type_member'] == 'Committe') echo 'selected'; ?>>Committe</option>
                        <
                    </select>
                    </div>
