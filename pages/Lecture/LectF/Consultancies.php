...
<div class="container pt-50">
    ...
    <?php
     ...
     // Tarik maklumat yang berkaitan dengan pengguna 
      $query = "SELECT * FROM consultancies WHERE staff_id = '$user_id'";
         $count =1;
    ...
    if ($result) {
      ...
      ?>
        <tr>
            ...
            <a href="editconsultancies.php?ID=<?php echo $row['reference_no']; ?>" class="btn btn-primary btn-sm"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
        </tr>
        <?php
          $count = $count+1;
              }
