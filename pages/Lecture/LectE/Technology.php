    ...
    <tbody id="myTable">
       ...
       <?php
          ...
          // Tarik maklumat yang berkaitan dengan pengguna 
           $query = "SELECT * FROM know_licen WHERE staff_id = '$user_id'";
           $count =1;
      ...
      ?>
        <tr>
                ...
                <td style="text-align: center;"><a href="editTech.php?ID=<?php echo $row['tech_id']; ?>" class="btn btn-primary btn-sm"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                </td>
        </tr>
        <?php 
          $count = $count+1;
