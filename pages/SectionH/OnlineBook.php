...
if(isset($_GET['delid']))
{
  ...
  echo"<script>window.location='OnlineBook.php?';</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="text-right mb-3">
    ...
    <tbody>
          <?php
                require_once "../examples/config.php";
                $sql = mysqli_query($conn,"SELECT * FROM Library WHERE type = 'Online Book'");
                $AmtTitle = 0;
                $TotVolume = 0;
                $count =1;
        ...
        <tr>
            ...
            <a href="OnlineBook.php?delid=<?php echo htmlentities($row['id']); ?>" onClick="return confirm('Do you really want to remove this Record?');" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash fs-5 me-3"></i></a></td>
         <?php
               $count = $count+1;
                 }
              }
