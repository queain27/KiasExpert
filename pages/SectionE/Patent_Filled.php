...
<!--Main Content-->
<!--TableStart-->  
<h3><center><font color="" face="Cambria Math">Patents Filed<font><br></center></h3>
<br><br>
<div class="container pt-50">
<div class="text-right mb-3">
        <a href="../sectionE/addPatentFill.php" class="btn btn-success">+Add New Patent Filled</a>
      </div>
...
require_once "../examples/config.php";
    ...
    $query = "SELECT * FROM patent_filed";
    $count =1;
