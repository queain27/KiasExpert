...
if(isset($_GET['delid']))
{
  $matric_no=intval($_GET['delid']);
  $sql =mysqli_query($conn,"DELETE FROM ug_student WHERE matric_no ='$matric_no'");
  echo"<script>alert('Record has been succesfully Deleted!!');</script>";
  echo"<script>window.location='UndergraduateStud.php?';</script>";
}
?>
...
<!--Main Content-->
<!--TableStart-->  
<h3><center><font color="" face="Cambria Math">Undergraduate Student<font><br></center></h3>
<div class="container pt-50">
<div class="row">
     <div class="text-right mb-3">
        <a href="../sectionA/addUStudent.php" class="btn btn-success">+Add New Student</a>
      </div>
    <div class="table-responsive">
        <table id="example" class="table table-striped" style="width:200%">
            ...
            <th style="text-align: center">Year Enrolled</th>
    ...
    ?>
            <tr>
                ...
                <td style="text-align: center"><?php echo $row['year_enroll']; ?></td>
                ...
                <td style="text-align: center;">
                    <a href="editUStudent.php?ID=<?php echo $row['matric_no']; ?>" class="btn btn-primary btn-sm">
                        <i class="fa-solid fa-pen-to-square fs-5 me-3"></i>
                    </a>
                    <a href="UndergraduatedStud.php?delid=<?php echo htmlentities($row['matric_no']); ?>" 
