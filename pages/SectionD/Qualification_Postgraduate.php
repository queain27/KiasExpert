...
if (isset($_GET['delid'])) {
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>document.location='Qualification_Postgraduate.php';</script>";
    } else {
...
<head>
    ...
    <title>Qualification Postgraduated</title>
...
<!--Main Content-->
<!--TableStart-->  
<h3><center><font color="" face="Cambria Math">Entry Qualification LevelOf Postgraduates<font><br></center></h3>
<br><br>
<div class="container pt-50">
    ...
    <?php
        require_once "../examples/config.php";
         $query = "SELECT * FROM pg_student WHERE cgpa = 'YES'";
         $count =1;
    ...
    ?>
            <tr>
                ...
                <td style="text-align: center;">
                    ...
                    <a href="Qualification_Postgraduate.php?delid=<?php echo htmlentities($row['matric_no']); ?>" onClick="return confirm('Do you really want to remove this Record?');" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash fs-5 me-3"></i></a>
                </td>
            </tr>
        <?php
