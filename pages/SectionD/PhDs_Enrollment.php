...
if (isset($_GET['delid'])) {
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>document.location='PhDs_Enrollment.php';</script>";
    } else {
...
<!--Main Content-->
<!--TableStart-->  
<h3><center><font color="" face="Cambria Math">Number of PhDs Enrollment<font><br></center></h3>
<br><br>
    ...
    ?>
            <tr>
                ...
                <td style="text-align: center;">
                    ...
                    <a href="PhDs_Enrollment.php?delid=<?php echo htmlentities($row['matric_no']); ?>" onClick="return confirm('Do you really want to remove this Record?');" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash fs-5 me-3"></i></a>
                </td>
            </tr>
        <?php
