...
if (isset($_GET['delid'])) {
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>document.location='Internal_PhDs.php';</script>";
    } else {
...
<head>
    ...
    <title>International Postgraduated</title> 
...
<!--Main Content-->
<!--TableStart--> 
<h3><center><font color="" face="Cambria Math">International Postgraduated<font><br></center></h3>
<br><br>
<div class="container pt-50">
    ...
    <?php
        require_once "../examples/config.php";
         $query = "SELECT * FROM pg_student WHERE citizen ='foreign'";
         $count =1;
    ...
    ?>
            <tr>
                ...
                <td style="text-align: center;">
                    ...
                    <a href="Internal_PhDs.php?delid=<?php echo htmlentities($row['matric_no']); ?>" onClick="return confirm('Do you really want to remove this Record?');" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash fs-5 me-3"></i></a>
                </td>
            </tr>
        <?php
