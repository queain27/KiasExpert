...
<head>
  ...
  <title>Research books No Indexed</title><!--Link CSS-->
    ...
    <div class="table-responsive">
        <table id="example" class="table table-striped" style="width:250%">
            <thead>
                ...
                <th style="text-align: center">Book Editor</th>
                <th style="text-align: center">Chapter Tittle</th>
           ...
           if ($result) {
            ...
            echo "<script>window.location.href='ResearchBookNoIndex.php';</script>"; // Redirect to avoid resubmission
           } else {
       ...
       ?>
            ...
            $query = "SELECT * FROM book WHERE book_status = 'NO INDEX'";
            ...
            <tr>
                ...
                <td style="text-align: center"><?php echo $row['book_editor']; ?></td>
                <td style="text-align: center"><?php echo $row['chapter_title']; ?></td>
               ...
               <td style="text-align: center;">
                    ...
                    <a href="ResearchBookNoIndex.php?delid=<?php echo urlencode($row['staff_id']); ?>" 
