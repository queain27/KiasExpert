...
if (isset($_POST['submit'])) { 
  ...
  // Bind the parameters
  $stmt->bind_param("isssssssiissssssiiissi",$staff_id,$staff_name, $faculty,$st, $staff_status, $research_title,$start_date,$end_date, $page_end, $duration_project,$status_project, $project_extension,$project_extend,$sponsor_cat, 
    $sponsor, 
    $grant_name, 
    $amt_pledge, 
    $amt_rec, 
