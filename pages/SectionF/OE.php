...
if (isset($_GET['delid'])) {
    ...
    $stmt = $conn->prepare("DELETE FROM oe WHERE reference_no = ?");
...
<div class="container pt-50">
    ...
    <div class="text-right mb-3">
        <a href="../sectionF/addOE.php" class="btn btn-success">+Add New</a>
    </div>
    ...
    if ($result) {
      ...
      ?>
        <tr>
            ...
            <a href="../sectionF/editOE.php?ID=<?php echo $row['reference_no']; ?>" class="btn btn-primary btn-sm"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
            <a href="OE.php?delid=<?php echo htmlentities($row['reference_no']); ?>" onClick="return confirm('Do you really want to remove this Record?');" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash fs-5 me-3"></i></a></td>
        </tr>
        <?php
          $count = $count+1;
              }
