...
if (isset($_GET['delid'])) {
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>document.location='Lab_Service.php';</script>";
    } else {
...
<div class="container pt-50">
    ...
    <div class="table-responsive">
        <table id="example" class="table table-striped" style="width:200%">
            ...
            <th style="text-align: center">Lab/ Health Clinic</th>
    ...
    <?php
        require_once "../examples/config.php";
         $query = "SELECT * FROM hosp_lab WHERE type = 'lab service'";
         $count =1;
    ...
    if ($result) {
      ...
      ?>
        <tr>
            ...
            <a href="Lab_Service.php?delid=<?php echo htmlentities($row['reference_no']); ?>" onClick="return confirm('Do you really want to remove this Record?');" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash fs-5 me-3"></i></a>
            </td>
        </tr>
        <?php
          $count = $count+1;
