...
<div class="container pt-50">
    ...
    ?>
        <tr>
            ...
            <a href="Product.php?delid=<?php echo htmlentities($row['reference_no']); ?>" onClick="return confirm('Do you really want to remove this Record?');" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash fs-5 me-3"></i></a>
            </td>
        </tr>
        <?php
          $count = $count+1;
